...
class FullBlockTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.genesis_hash = int(gen_hash, 16)
        ...
        b3.solve(self.signblockprivkey)
        self.tip = b3
        ...
        # proof is added here.
        b23.solve(self.signblockprivkey)
        tx = CTransaction()
        ...
        b24.solve(self.signblockprivkey)
        ...
        lastOutpoint = COutPoint(b40.vtx[1].malfixsha256, 0)
        new_txs = []
        for i in range(1, numTxes + 1):
            ...
            tx.rehash()
            new_txs.append(tx)
            lastOutpoint = COutPoint(tx.malfixsha256, 0)
        ...
        b44.solve(self.signblockprivkey)
        self.tip = b44
        ...
        b45.calc_sha256()
        b45.solve(self.signblockprivkey)
        ...
        b46.solve(self.signblockprivkey)
        ...
        b48.solve(self.signblockprivkey)
        ...
        b49.solve(self.signblockprivkey)
        ...
        b54.solve(self.signblockprivkey)
        ...
        tx.vin.append(CTxIn(COutPoint(out[17].malfixsha256, 42), CScript([OP_TRUE]), 0xffffffff))
        ...
        tx.vin.append(CTxIn(COutPoint(out[18].malfixsha256, 0)))  # don't set nSequence
        ...
        b64.solve(self.signblockprivkey)
